...
description: Use when working on React or Next.js performance, rendering behavior, data fetching, Suspense, bundle size, or component architecture. Do not use for styling-only tasks.
---
