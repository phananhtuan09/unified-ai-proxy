...
description: Use when the task involves linting, type checking, build verification, or debugging failing validation. Prefer project-native commands and focused checks before broad fixes.
---
