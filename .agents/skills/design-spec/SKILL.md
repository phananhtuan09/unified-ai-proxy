...
11. Validate the plan before opening the review:
    ...
    ```bash
    python3 .agents/skills/design-spec/scripts/validate_design_plan.py docs/ai/designs/{feature_slug}.json --repo-root <repo-root>
    ```
...
12. Start or reuse the local runner:
    ...
    ```bash
    python3 .agents/skills/design-spec/scripts/design_review_server.py --repo-root <repo-root> start docs/ai/designs/{feature_slug}.json
    ```
